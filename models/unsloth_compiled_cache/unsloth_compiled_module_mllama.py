...
from transformers.models.mllama.modeling_mllama import (F, math, List, Optional, Tuple, Union, torch, nn, PreTrainedModel, ACT2FN, Cache, GenerationMixin, CausalLMOutputWithPast, ROPE_INIT_FUNCTIONS, dynamic_rope_update, add_start_docstrings, add_start_docstrings_to_model_forward, replace_return_docstrings, deprecate_kwarg, MllamaTextConfig, MllamaVisionConfig, __name__, MllamaPreTrainedModel, MLLAMA_START_DOCSTRING, MLLAMA_INPUTS_DOCSTRING, MllamaTextModel, MllamaForCausalLM)
...
class MllamaForCausalLM(MllamaPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **loss_kwargs,
        ...
        return MllamaForCausalLM_forward(self, input_ids, attention_mask, position_ids, cross_attention_states, cross_attention_mask, full_text_row_masked_out_mask, past_key_values, inputs_embeds, labels, use_cache, output_attentions, output_hidden_states, return_dict, cache_position, logits_to_keep, **loss_kwargs)

...
from models.dinov2_advanced import DinoV2Finetune
...
def train_wandb(cfg):
    ...
    with wandb.init(
        project="challenge_CSC_43M04_EP_Multimodal_advanced_sweep_with_normalization",
        config=wandb_cfg,
...
if __name__ == "__main__":
    sweep_id = wandb.sweep(sweep_config, project="challenge_CSC_43M04_EP_Multimodal_advanced_sweep_with_normalization")
